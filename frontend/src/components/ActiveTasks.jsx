  ...
  return (
    <section className="card p-5">
      <div className="mb-4 flex items-center justify-between gap-3">
        <div>
          <h2 className="text-base font-bold text-slate-950">Aktif görevler</h2>
          <p className="text-sm text-slate-500">n8n template bağlantılı akışlar</p>
        </div>
          ...
          <div className="rounded-lg border border-line bg-white p-3" key={task.id}>
            <div className="mb-3 flex items-start justify-between gap-3">
              <div className="min-w-0">
                ...
                <p className="mt-1 break-words text-xs text-slate-500">{task.workflowTemplate}</p>
              </div>
